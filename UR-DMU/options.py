...
def parse_args():
    ...
    parser.add_argument('--num_workers', type = int, default = 2) #default was 0
    ...
    # add checkpoint for fine-tuning
    parser.add_argument('--checkpoint_path', type = str, default = None, help = 'ruta checkpoint para fine-tuning')
