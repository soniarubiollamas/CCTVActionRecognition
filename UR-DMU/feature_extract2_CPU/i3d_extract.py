...
def run(args_item):
    ...
    # setup the model  
        ...
        # i3d.cuda()  
        i3d.load_state_dict(torch.load(load_model, map_location=torch.device('cpu')))  # Cargar modelo en CPU
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', default="C:/Users/xoni/Documents/1_uni/1_insterships/UR-DMU/UCF_Crime_Frames/test",type=str)
