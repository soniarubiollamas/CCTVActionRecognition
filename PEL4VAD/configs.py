...
def build_config(dataset):
    ...
    if dataset in ['ucf', 'ucf-crime']:
        ...
        cfg.test_list = './list/ucf/test_extended_20.list'
        ...
        cfg.ckpt_path = './ckpt/ucf__8636.pkl' # original './ckpt/ucf__8636.pkl' nuevo './ckpt/ucf__8615.pkl'
