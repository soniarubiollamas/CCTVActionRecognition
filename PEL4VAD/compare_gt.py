...
def plot_pel4vad_and_gt(folder_pel4vad, folder_gt, filename, label_pel4vad, label_gt, ax):
    ...
    fpr, tpr, thresholds = roc_curve(data_gt,data_pel4vad)
    roc_auc = auc(fpr, tpr)
    precision, recall, _ = precision_recall_curve(data_gt, data_pel4vad)
    pr_aucs= auc(recall, precision)
...
for i, archivo in enumerate(archivos_seleccionados):
    ...
    folder_pel4vad = f'C:/Users/xoni/Documents/1_uni/1_insterships/cuda_version/PEL4VAD-master/predictions/{mode}/windows/PEL4VAD/{filename}'
    folder_gt = f'C:/Users/xoni/Documents/1_uni/1_insterships/cuda_version/PEL4VAD-master/predictions/gt/windows/{filename}'
